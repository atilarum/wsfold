...
GO_LDFLAGS := -X github.com/atilarum/wsfold/internal/buildinfo.Version=$(VERSION) -X github.com/atilarum/wsfold/internal/buildinfo.Commit=$(COMMIT) -X github.com/atilarum/wsfold/internal/buildinfo.Date=$(DATE)
